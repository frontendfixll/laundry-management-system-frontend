...
import { tenantBlogApi } from '@/services/tenantBlogApi'
import { 
  BarChart3, 
  Eye, 
  FileText, 
...
export default function TenantBlogAnalyticsPage() {
  const [analytics, setAnalytics] = useState<TenantBlogAnalytics | null>(null)
  ...
  const fetchAnalytics = async () => {
    try {
      setLoading(true)
      const response = await tenantBlogApi.getTenantAnalytics(timeframe)
