...
export default function CreateTenantBlogPostPage() {
  ...
  const handleSubmit = async (e: React.FormEvent, status: 'draft' | 'published' = 'draft') => {
    ...
    try {
      ...
      await tenantBlogApi.createTenantPost(postData)
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Write helpful content for your customers</p>
          </div>
        </div>
      </div>
