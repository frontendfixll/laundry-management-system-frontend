  ...
  const fetchOrders = async () => {
    try {
      ...
      if (response.success) {
        ...
        setTotalOrders(response.data.pagination?.totalItems || response.data.total || ordersData.length)
        
        // Calculate stats from all orders (separate call without pagination)
