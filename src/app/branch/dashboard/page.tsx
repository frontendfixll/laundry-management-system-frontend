      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="flex items-center justify-between p-5 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
            ...
            <Link href="/branch/orders" className="text-emerald-600 text-sm font-medium flex items-center group">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
            ...
            <div className="space-y-3">
              <Link href="/branch/orders" className="flex items-center p-4 bg-emerald-50 rounded-xl hover:bg-emerald-100 transition-all group">
              ...
              <Link href="/branch/staff" className="flex items-center p-4 bg-gray-50 rounded-xl hover:bg-purple-50 transition-all group">
              ...
              <Link href="/branch/performance" className="flex items-center p-4 bg-gray-50 rounded-xl hover:bg-blue-50 transition-all group">
