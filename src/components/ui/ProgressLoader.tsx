        ...
        <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-gray-50/90 backdrop-blur-md">
            <div className="w-full max-w-md px-8">
                ...
                <div className="relative mb-12 text-center">
                    <span className="text-8xl font-black text-transparent bg-clip-text bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 tabular-nums">
                        {Math.round(progress)}%
                    </span>
                ...
                <div className="relative h-2 w-full bg-gray-200 rounded-full overflow-hidden shadow-inner">
                    ...
                    <div
                        className="absolute top-0 left-0 h-full bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-600 transition-all duration-500 ease-out rounded-full shadow-[0_0_15px_rgba(37,99,235,0.5)]"
                ...
                <div className="mt-6 flex justify-between items-center px-1">
                    ...
                    <div className="flex gap-1.5">
                        {[1, 2, 3].map((i) => (
                            <div
                                key={i}
                                className={`w-1.5 h-1.5 rounded-full transition-all duration-300 ${progress >= (i * 33) ? 'bg-blue-500 scale-110' : 'bg-gray-200'
                                    }`}
                            />
                        ))}
                    </div>
